function [ttDOT, piDOT, tmDOT] = dot_to_transition(filename,alphabet)
...
% Evaluate state asymptotics from state sequence
...
disp('dot_to_transition: Check there are no CG2k alphabet letters skipped!')
